...
Ext.define('Earh.cmp.PdfPanel', {
	extend: 'Ext.panel.Panel',
	alias: 'widget.pdfpanel',
	requires: [
		'Ext.LoadMask',
		'Ext.data.SimpleStore',
		'Earh.cmp.TextLayerBuilder'
	],
...
//					id: 0,
	...
	initComponent: function () {
		...
		me.on('boxready', function () {
			me.loader = Ext.create('Ext.LoadMask', {
				target: me.child('#pdfPageContainer'),
	...
	renderPage: function (num) {
		...
		me.pdfDoc.getPage(num).then(function (page) {
			...
			var textLayer = me.textLayerDiv ? Ext.create('Earh.cmp.TextLayerBuilder', {
